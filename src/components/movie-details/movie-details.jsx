        ...
        <div className="movie-card__hero">
          ...
          <div className="movie-card__wrap">
            <div className="movie-card__desc">
              <h2 className="movie-card__title">{movie ? movie.name : ``}</h2>
              <p className="movie-card__meta">
                <span className="movie-card__genre">{movie ? movie.genre : ``}</span>
                <span className="movie-card__year">{movie ? movie.released : ``}</span>
              </p>
